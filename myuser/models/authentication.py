...
class AccessKey(models.Model):
    id = models.UUIDField(default=uuid.uuid4, primary_key=True, editable=False, verbose_name=_("AccessKeyID"))
    secret = models.UUIDField(default=uuid.uuid4, editable=False, verbose_name=_("AccessKeySecret"))
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='access_key', verbose_name=_("User"))
...
class LoginLog(models.Model):
    ...
    static = models.BooleanField(max_length=2, default=True, choices=STATUS_CHOICE, verbose_name=_("Status"))
